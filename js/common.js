...
const translations = {
  'zh-TW': {
    ...
    'about.pro.tagline': '產品規劃、UX研究與跨媒介設計',

    'about.pro.1.title': '產品與專案規劃',
    'about.pro.1.desc': '需求訪談、問題定義、功能與流程拆解，協助建立專案範圍、交付標準及優先順序。具備時程、版本、成本、資源、風險與待辦追蹤能力，能獨立推動跨部門協作，並參與 B2C 產品上市、日常營運、展會活動、餐飲品牌及外部供應商專案。',
    'about.pro.1.tools': '主要工具：Excel、Google Sheets、PowerPoint、Google Slides、FigJam',

    'about.pro.2.title': 'UX研究與Product Design',
    'about.pro.2.desc': '使用者訪談、問卷設計、研究與測試流程規劃，具備量化統計、質性主題分析及洞察整理經驗。熟悉資訊架構、User Flow、Wireframe、高保真原型、Design System、元件庫、RWD 網站與跨平台互動規範，能將研究結果轉化為產品需求及體驗優化方向。',
    'about.pro.2.tools': '主要工具：Figma、FigJam、SPSS、Wix／Wix Studio',

    'about.pro.3.title': '品牌與視覺設計',
    'about.pro.3.desc': '品牌定位、Logo、CIS／VI、色彩與視覺系統規劃，並延伸至菜單、包裝、社群素材、活動主視覺、店面及數位接觸點。熟悉需求收斂、提案、完稿、印刷、打樣與供應商協作。',
    'about.pro.3.tools': '主要工具：Illustrator、Photoshop',

    'about.pro.4.title': '插畫與影音製作',
    'about.pro.4.desc': '具備日系人物、角色、漫畫分鏡、產品插圖及遊戲美術製作能力，亦可執行人像、商品、活動與品牌攝影，以及形象影片、訪談、活動紀錄和社群短影音之企劃、拍攝、剪輯與調色。',
    'about.pro.4.tools': '主要工具：Clip Studio Paint、DaVinci Resolve、剪映、Sony α 系列相機',

    'about.pro.5.title': '實體與空間設計',
    'about.pro.5.desc': '商品包裝、禮贈品、展場攤位、陳列道具與空間視覺提案，熟悉 3D 模擬、結構打樣、材質評估、成本與量產管理。',
    'about.pro.5.tools': '主要工具：Rhino、SketchUp、KeyShot、AutoCAD',

    'about.pro.tag1': '#插畫表現技巧',
    'about.pro.tag2': '#設計表現能力',
    'about.pro.tag3': '#使用者體驗設計',
    'about.pro.tag4': '#數位攝影技巧',
    'about.pro.tag5': '#影音製作',
    'about.pro.tag6': '#Canva',
    'about.pro.tag7': '#AI圖像生成',
  ...
  'en': {
    ...
    'about.pro.title': 'Professional <em>Expertise</em>',
    'about.pro.tagline': 'Product planning, UX research, and cross-media design.',

    'about.pro.1.title': 'Product & Project Planning',
    'about.pro.1.desc': 'Requirements interviews, problem definition, and breakdown of features and workflows to help establish project scope, delivery standards, and priorities. Skilled in tracking schedules, versions, cost, resources, risk, and to-dos; able to independently drive cross-department collaboration, with experience across B2C product launches, daily operations, exhibitions, F&B branding, and external vendor projects.',
    'about.pro.1.tools': 'Tools: Excel, Google Sheets, PowerPoint, Google Slides, FigJam',

    'about.pro.2.title': 'UX Research & Product Design',
    'about.pro.2.desc': 'User interviews, questionnaire design, and research/testing process planning, with experience in quantitative statistics and qualitative thematic analysis. Familiar with information architecture, user flows, wireframes, high-fidelity prototypes, design systems, component libraries, RWD websites, and cross-platform interaction guidelines — translating research insights into product requirements and experience improvements.',
    'about.pro.2.tools': 'Tools: Figma, FigJam, SPSS, Wix/Wix Studio',

    'about.pro.3.title': 'Branding & Visual Design',
    'about.pro.3.desc': 'Brand positioning, logo, CIS/VI, color and visual systems, extending to menus, packaging, social media assets, event key visuals, storefronts, and digital touchpoints. Experienced in requirement refinement, proposals, final artwork, printing, proofing, and vendor coordination.',
    'about.pro.3.tools': 'Tools: Illustrator, Photoshop',

    'about.pro.4.title': 'Illustration & Video Production',
    'about.pro.4.desc': 'Capable of Japanese-style character illustration, comic storyboarding, product illustration, and game art, as well as portrait, product, event, and brand photography, plus planning, filming, editing, and color grading for brand films, interviews, event documentation, and short-form social videos.',
    'about.pro.4.tools': 'Tools: Clip Studio Paint, DaVinci Resolve, CapCut, Sony α series cameras',

    'about.pro.5.title': 'Physical & Spatial Design',
    'about.pro.5.desc': 'Product packaging, gifts, exhibition booths, display props, and spatial visual proposals, with experience in 3D simulation, structural prototyping, material evaluation, cost control, and production management.',
    'about.pro.5.tools': 'Tools: Rhino, SketchUp, KeyShot, AutoCAD',

    'about.pro.tag1': '#IllustrationSkills',
    'about.pro.tag2': '#DesignPresentation',
    'about.pro.tag3': '#UXDesign',
    'about.pro.tag4': '#DigitalPhotography',
    'about.pro.tag5': '#VideoProduction',
    'about.pro.tag6': '#Canva',
    'about.pro.tag7': '#AIImageGeneration',
